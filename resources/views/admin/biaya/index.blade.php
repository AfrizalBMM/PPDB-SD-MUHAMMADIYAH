            ...
            <tr class="hover:bg-slate-50 transition">
                ...
                <td class="px-4 py-2 flex gap-2">
                    ...
                    <form method="POST" action="{{ route('biaya.toggle',$b) }}">
                        @csrf
                        <x.button type="submit" class="bg-blue-500 hover:bg-blue-600 text-xs px-2 py-1">
                            Toggle
                        </x.button>
                    </form>
                    ...
                    <x.button 
                        type="button"
                        onclick="openDeleteModal('{{ route('biaya.destroy',$b) }}')"
                        class="bg-red-500 hover:bg-red-600 text-xs px-2 py-1"
                    >
                        Hapus
                    </x.button>
