                ...
                <form action="{{ route('landing-galleries.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="file" name="image" required class="text-xs text-slate-600 file:mr-4 file:rounded-lg file:border-0 file:bg-blue-100 file:px-4 file:py-2 file:text-xs file:font-semibold file:text-blue-700 hover:file:bg-blue-200">
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end gap-3 mt-8">
                        ...
                        <button type="submit" class="rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-700">Upload Foto</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div x-show="showEdit" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block w-full max-w-lg my-8 overflow-hidden rounded-2xl bg-white p-8 text-left align-middle shadow-xl transition-all transform">
                ...
                <form :action="'{{ url('admin/landing-galleries') }}/' + editData.id" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="flex justify-end gap-3 mt-8">
                        ...
                        <button type="submit" class="rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-700">Perbarui Foto</button>
                    </div>
                </form>
            </div>
        </div>
